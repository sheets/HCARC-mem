...
server "192.241.221.93", :web, :app, :db, primary: true
# ask :branch, proc { `git rev-parse --abbrev-ref HEAD`.chomp }
set :application, 'hcare'
set :user, 'root'
set :deploy_to, "/home/rails"
set :deploy_via, :remote_cache
set :use_sudo, true
set :rails_env, "production"
set :rvm_ruby_string, 'ruby-1.9.3-p484@default'
...
set :scm, :git
set :repository,"git@github.com:sheets/HCARC-mem.git"
set :branch, "master"
...
namespace :deploy do
  ...
  #       run "cp #{latest_release}/public/assets.tar.bz2 #{shared_path}"
